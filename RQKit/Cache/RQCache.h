...
@class RQMemoryCache, RQDiskCache;

NS_ASSUME_NONNULL_BEGIN

@interface RQCache : NSObject

/** The name of the cache, readonly. */
@property (copy, readonly) NSString *name;

/** The underlying memory cache. see `RQMemoryCache` for more information.*/
@property (strong, readonly) RQMemoryCache *memoryCache;

/** The underlying disk cache. see `RQDiskCache` for more information.*/
@property (strong, readonly) RQDiskCache *diskCache;
