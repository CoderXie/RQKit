 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `RQModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface RQAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation RQAuthor
     @end
 
     @interface RQBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) RQAuthor *author;
     @end
     @implementation RQBook
     @end
    
     int main() {
         // create model from json
         RQBook *book = [RQBook modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 ...
 @code
     @interface RQShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation RQShadow
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "RQRQ-MM-dd'T'HH:mm:ssZ", "RQRQ-MM-dd HH:mm:ss" or "RQRQ-MM-dd".
     `NSString` -> NSURL.
 ...
 */
@interface NSDictionary (RQModel)
...
/**
 ...
 There's no need to add '<RQModel>' to your class header.
 */
@protocol RQModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class RQShadow, RQBorder, RQAttachment;
 
        @interface RQAttributes
        @property NSString *name;
        ...
        @implementation RQAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [RQShadow class],
                     @"borders" : RQBorder.class,
                     @"attachments" : @"RQAttachment" };
        }
        @end
 @endcode
...
/**
 ...
 Example:
 @code
        @class RQCircle, RQRectangle, RQLine;
 
        @implementation RQShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [RQCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [RQRectangle class];
