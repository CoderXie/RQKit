...
void RQ_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void RQ_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void RQ_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void RQ_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void RQ_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void RQ_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void RQ_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void RQ_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (UIColor *)colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    RQ_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (UIColor *)colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    RQ_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
- (BOOL)getHue:(CGFloat *)hue
    ...
    RQ_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
...
- (BOOL)getCyan:(CGFloat *)cyan
    ...
    RQ_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
